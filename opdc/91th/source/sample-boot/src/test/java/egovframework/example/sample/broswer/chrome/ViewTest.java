...
//		options.setHeadless(true);
	...
	@Test
	public void testHttptagfilterTestCase() throws Exception {
		driver.get(baseUrl + "/egovSampleList.do");
		driver.findElement(By.linkText("등록")).click();
		driver.findElement(By.id("name")).click();
		driver.findElement(By.id("name")).sendKeys("등록테스트");
		driver.findElement(By.id("description")).click();
		driver.findElement(By.id("description")).sendKeys("<scpipt>Alert('test')</script>");
		driver.findElement(By.id("regUser")).click();
		driver.findElement(By.id("regUser")).sendKeys("TESTTER");
		driver.findElement(By.linkText("등록")).click();
	}
	
	@Test
	public void testLanguageTestCase() throws Exception {
		driver.get(baseUrl + "/egovSampleList.do?language=en");
		String title = driver.getTitle();
		assertThat(title, is("Default BBS List"));
	}
