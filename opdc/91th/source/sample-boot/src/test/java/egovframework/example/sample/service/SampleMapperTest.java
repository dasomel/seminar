...
@DirtiesContext
@SpringBootTest
public class SampleMapperTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testInsertSample() throws Exception {
        ...
        SampleVO returnVO = sampleMapper.selectSample(sampleVO);
    ...
    public void testDeleteSample() throws Exception {
    	sampleVO.setId("SAMPLE-00001");
    	sampleMapper.deleteSample(sampleVO);
    	
    	List<?> resultList = sampleMapper.selectSampleList(searchVO);
    	assertThat(resultList, is(notNullValue()));
        assertThat(resultList.size(), is(10));
        assertThat(((List<EgovMap>)resultList).get(0).get("id"), is("SAMPLE-00002"));
    }
    ...
    public void testSelectSampleList() throws Exception {
		...
		assertThat(resultList, is(notNullValue()));
        assertThat(resultList.size(), is(10));
        assertThat(((List<EgovMap>)resultList).get(0).get("id"), is("SAMPLE-00001"));
    }
    ...
    public void testSelectSampleList_Paging() throws Exception {
    	...
    	assertThat(resultList, is(notNullValue()));
    	assertThat(resultList.size(), is(10));
    	assertThat(((List<EgovMap>)resultList).get(0).get("id"), is("SAMPLE-00011"));
    }
    ...
    public void testSelectSampleList_SearchId() throws Exception {
    	...
    	assertThat(((List<EgovMap>)resultList).get(0).get("id"), is("SAMPLE-00110"));
    }
    ...
    public void testSelectSampleListCnt() throws Exception {
		int resultCnt = sampleMapper.selectSampleListTotCnt(searchVO);
